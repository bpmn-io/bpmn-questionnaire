...
Questions.prototype.render = function(state) {
  ...
  var html = [
    ...
    h('div.bpmn-questionnaire-question.bpmn-questionnaire-u-5-5', [
      h('h2', 'Frage ' + (state.currentQuestion + 1) + ' von ' + this.questionnaire.questionnaireJson.questions.length),
